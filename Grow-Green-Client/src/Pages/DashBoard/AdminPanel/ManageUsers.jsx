                ...
                {users.map(user => (
                    ...
                    >
                        ...
                        <div className="flex gap-2">
                            <button
                                onClick={() => updateUserRole(user._id, 'salesman')}
                                className={`px-4 py-2 rounded-md text-white font-medium shadow-md transition-colors ${user.role === 'salesman' ? 'bg-blue-600' : 'bg-blue-500 hover:bg-blue-600'}`}
                            >
                                Make Salesman
                            </button>
                            <button
