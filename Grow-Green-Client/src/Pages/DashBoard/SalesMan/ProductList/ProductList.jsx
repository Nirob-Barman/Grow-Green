...
//                     <div className="bg-white w-full sm:w-96 p-6 rounded shadow-md">
        ...
        <div className="flex flex-col items-center m-4">
            ...
            <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                {products.map((productData) => (
                    <div
                        key={productData._id}
                        className={`border p-4 ${productData?.status === 'denied' ? 'bg-red-200' : 'bg-white'}`}
                    >
                        <h3 className="font-bold">{productData?.productName}</h3>
                        <p>Status: {productData?.status}</p>
                        <p>Available Products: {productData?.availableProducts}</p>
                        <p>Feedback: {productData?.feedback ? productData.feedback : "N/A"}</p>
                        <button
